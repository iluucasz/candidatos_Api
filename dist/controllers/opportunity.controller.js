...
let OpportunityController = class OpportunityController {
    constructor(opportunityService) {
        ...
        this.create = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            const create = yield this.opportunityService.create(body, id);
        ...
        this.findOne = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            const search = yield this.opportunityService.findOne(params);
...
exports.OpportunityController = OpportunityController = __decorate([
    ...
    __metadata("design:paramtypes", [opportunity_service_1.OpportunityServices])
